<?php 
    ...
    $message .= "<div style='background-color: #FF5722; padding: 20px; text-align: center;'>";
    $message .= "<h2 style='color: #ffffff; margin: 0;'>Reminder: Pending Audit Findings</h2>";
    $message .= "</div>";
    ...
    $message .= "<p style='color: #333333; font-size: 14px; line-height: 1.6;'>This is a friendly reminder that you have <strong>pending audit findings</strong> that require your response for the following Model and Process / Area:</p>";
    $message .= "<div style='background-color: #fbe9e7; padding: 15px; border-left: 4px solid #FF5722; margin: 15px 0;'>";
    $message .= "<p style='color: #333333; font-size: 14px; margin: 0;'><strong>" . $model . ", " . $processArea . "</strong></p>";
    $message .= "</div>";
    $message .= "<p style='color: #333333; font-size: 14px; line-height: 1.6;'>Please submit your response as soon as possible by clicking the link below:</p>";
    $message .= "<p style='text-align: center; margin: 20px 0;'>";
    $message .= "<a href='http://192.168.132.170/fophaudit/' style='background-color: #FF5722; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 4px;'>Audit Management System</a>";
    $message .= "</p>";
    $message .= "<p style='color: #333333; font-size: 14px; line-height: 1.6;'>Your prompt attention to this matter is highly appreciated.</p>";
    ...
    $mail->isHTML(true);
    $mail->Subject = "Reminder: For Audit Findings (Audit MS Notification)";
    $mail->Body = $message;
