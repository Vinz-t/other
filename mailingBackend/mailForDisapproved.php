<?php
    ...
    $disapprovalReason = $_POST['disapprovalReason'] ?? '';
    ...
    $message .= "<div style='background-color: #f44336; padding: 20px; text-align: center;'>";
    $message .= "<h2 style='color: #ffffff; margin: 0;'>Corrective Response Disapproved</h2>";
    $message .= "</div>";
    ...
    $message .= "<p style='color: #333333; font-size: 14px; line-height: 1.6;'>This is to inform you that the Root Cause Analysis submitted for Control Code No. <strong>" . $controlCode . "</strong> has been <strong style='color: #f44336;'>disapproved</strong>.</p>";
    $message .= "<div style='background-color: #fff3f3; padding: 15px; border-left: 4px solid #f44336; margin: 15px 0;'>";
    $message .= "<p style='color: #333333; font-size: 14px; margin: 0;'><strong>Reason for Disapproval:</strong><br>" . $disapprovalReason . "</p>";
    $message .= "</div>";
    $message .= "<p style='color: #333333; font-size: 14px; line-height: 1.6;'>Please review the feedback and resubmit a revised Root Cause Analysis.</p>";
    ...
    $message .= "<a href='http://192.168.132.170/fophaudit/' style='background-color: #f44336; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 4px;'>Audit Management System</a>";
    $message .= "</p>";
    ...
    $mail->isHTML(true);
    $mail->Subject = "Disapproved Response: Control Code No. " . $controlCode . " (Audit MS Notification)";
    $mail->Body = $message;
