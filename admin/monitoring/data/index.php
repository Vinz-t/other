...
<head>
    ...
    <title>Monitoring Data | Audit MS</title>
...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="text-muted"><i class="mdi mdi-calendar-range me-1"></i>Start Date</label>
                                                <input type="date" id="min-date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="text-muted"><i class="mdi mdi-calendar-range me-1"></i>End Date</label>
                                                <input type="date" id="max-date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="text-muted"><i class="mdi mdi-format-list-checks me-1"></i>Category of Audit</label>
                                                <select id="audit-category" class="form-select">
                                                    <option selected disabled>Select Category</option>
                                                    <option value="Normal Audit">Normal Audit</option>
                                                    <option value="New Changes">New Changes</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="text-muted"><i class="mdi mdi-office-building me-1"></i>Division</label>
                                                <select id="auditee-division" class="form-select">
                                    ...
                                    <!-- Auditors and action buttons -->
                                    <div class="row align-items-end">
                                        <div class="col-md-8">
                                            <label class="text-muted mb-2"><i class="mdi mdi-account-group me-1"></i>Auditors</label>
                                            <div id="auditor_list" class="d-flex flex-wrap gap-2">
                                                <span class="badge bg-danger">Please complete the fields above before proceeding.</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4 text-end">
                                            <button id="filter_btn" class="btn btn-primary rounded-3 fw-bold">
                                                <i class="mdi mdi-filter me-1"></i>Apply Filters
                                            </button>
                                            <button id="clear_btn" class="btn btn-outline-danger rounded-3 fw-bold ms-2">
                            ...
                            <table id="monitoringDataTable" class="table table-bordered table-striped">
                                <thead class="bg-secondary text-white">
                                    <tr>
                                        <th>No.</th>
                                        <th>Category of Audit</th>
                                        <th>Model & Process/Area</th>
                                        <th>Relevant Audit Results</th>
                                        <th>Findings Classification</th>
                                        <th>Status</th>
                                        <th>Date Audited</th>
                                        <th>Actions</th>
                                    </tr>
                                ...
                                <tbody class="text-center">
                                    <tr>
                                        <td>1</td>
                                        <td>PATROL AUDIT</td>
                                        <td>ALL RUNNING MODEL - PAINTING</td>
                                        <td>No good lenses do not have an 'NG' tag attached, which makes it difficult to identify their models and defects.</td>
                                        <td>OFI</td>
                                        <td>PAINTING LEADERS</td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end shadow">
                                                    ...
                                                    <li>
                                                    <a class="dropdown-item d-flex align-items-center gap-2 text-warning" href="#">
    ...
    <script src="../../../assets/js/auditorScript/monitoring_data.js"></script>
